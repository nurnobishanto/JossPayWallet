...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            @can('store_list')
                <a href="{{route('admin.stores.index')}}" class="btn btn-primary mt-2">{{__('global.go_back')}}</a>
            @endcan
                            ...
                            @foreach($stores as $store)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @can('store_delete')
                                        <a href="{{route('admin.stores.restore',['store'=>$store->id])}}"  class="btn btn-success btn-sm px-1 py-0"><i class="fa fa-arrow-left"></i></a>
                                        <a href="{{route('admin.stores.force_delete',['store'=>$store->id])}}"  class="btn btn-danger btn-sm px-1 py-0"><i class="fa fa-trash"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
