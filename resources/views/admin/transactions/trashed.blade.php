...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{__('global.transactions')}} {{__('global.deleted')}}</h1>
            @can('transaction_list')
                <a href="{{route('admin.transactions.index')}}" class="btn btn-primary mt-2">{{__('global.go_back')}}</a>
            @endcan
                            ...
                            @foreach($transactions as $store)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('admin.transactions.restore',['store'=>$store->id])}}"  class="btn btn-success btn-sm px-1 py-0"><i class="fa fa-arrow-left"></i></a>
                                        <a href="{{route('admin.transactions.force_delete',['store'=>$store->id])}}"  class="btn btn-danger btn-sm px-1 py-0"><i class="fa fa-trash"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
