...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            @can('user_create')
                <a href="{{route('admin.users.create')}}" class="btn btn-primary mt-2">{{__('global.add_new')}}</a>
            @endcan
            @can('user_delete')
                <a href="{{route('admin.users.trashed')}}" class="btn btn-danger mt-2">{{__('global.trash_list')}}</a>
            @endcan
