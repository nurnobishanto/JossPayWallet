...
@section('title', __('global.create_withdraw_account'))

@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1>{{ __('global.create_withdraw_account')}}</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{ __('global.home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.withdraw-accounts.index')}}">{{ __('global.withdraw_accounts')}}</a></li>
                <li class="breadcrumb-item active">{{ __('global.create_withdraw_account')}}</li>
            </ol>
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.withdraw-accounts.store')}}" method="POST" enctype="multipart/form-data" id="admin-form">
                        @csrf
                        @if (count($errors) > 0)
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="bank_name" name="bank_name" class="form-control"  placeholder="{{ __('global.enter_bank_name')}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="account_name" name="account_name" class="form-control" placeholder="{{ __('global.enter_account_name')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="account_no">{{ __('global.account_no')}}</label>
                                    <input id="account_no" name="account_no"  class="form-control" placeholder="{{ __('global.enter_account_no')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="branch_name" name="branch_name" class="form-control" placeholder="{{ __('global.enter_branch_name')}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="routing_no">{{ __('global.routing_no')}}</label>
                                    <input id="routing_no" name="routing_no" class="form-control" placeholder="{{ __('global.enter_routing_no')}}">
                                </div>
                            </div>
